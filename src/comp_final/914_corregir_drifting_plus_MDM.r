...
PARAM  <- list()
PARAM$experimento  <- "DR9141_plus_FINAL"
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[, inversa_ctrx := 1/ctrx_quarter]
...
#------------------------------
#función que calcula la media de una variable dividida por su media en el mes

valor_media  <- function( cols )
{
  sufijo  <- paste0( "_mdm")
...
#aqui aplico la función que agrega columnas del valor de la variable dividia la media en ese mes
valor_media( campos_monetarios )
