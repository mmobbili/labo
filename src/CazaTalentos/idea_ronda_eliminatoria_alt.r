...
head(peores_df)
elim_1ra <- tail(peores_df[order(peores_df$Freq),],65)   #los 25 que más aparecen en los experimentos, los que quedan afuera en esta ronda
elim_1ra
...
head(peores_2da_df)
elim_2da <- tail(peores_2da_df[order(peores_2da_df$Freq),],25)   #los 25 que más aparecen en los experimentos, los que quedan afuera en esta ronda
elim_2da
