...
dataset  <- dataset[  clase_ternaria =="BAJA+2"  & foto_mes>=202007  & foto_mes<=202105, ]
...
campos_buenos  <- c( "ctrx_quarter", "cpayroll_trx", "mcaja_ahorro", "mtarjeta_visa_consumo", "ctarjeta_visa_transacciones",
                     ...
                     "mpagomiscuentas", "cliente_vip", "vm_mconsumospesos", "vm_mconsumosdolares", "vm_mlimitecompra" )
